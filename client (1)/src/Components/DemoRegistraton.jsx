...
//   const {demoList, demoStudentData} = location.state
  ...
  const fetchRegistrationData = async () => {
    try {
      const registrationUrl = "https://dashboard-backend4-q7gq.onrender.com/getregisterStudent";
      const labelSet = [];
 ...
 const SearchDemo = async()=>{
  ...
  let selectDemo = await fetch("https://dashboard-backend4-q7gq.onrender.com/getRangeDemoes",{
    method:"GET",
    headers:{
 ...
 setFilterDemoStudent(selectDemo.totalDemoStudent)
  ...
  let selectRegister = await fetch("https://dashboard-backend4-q7gq.onrender.com/getRangeRegisteredStudent",{
    method:"GET",
    headers:{
      "startDate":rangeDate.startDate,
      "endDate":rangeDate.endDate
