...
const EditRunningBatch = () => {
    ...
    const getRunningBatchTrainer = async (trainer) => {
      ...
      try {
          let runningTrainer = await fetch('https://dashboard-backend4-q7gq.onrender.com/getRunningBatchTrainer', {
              method: 'POST',
...
const updateBatch = async () => {
  ...
  ContextValue.updateProgress(30)
    ContextValue.updateBarStatus(true)
  let addedNewBatch = await fetch(`https://dashboard-backend4-q7gq.onrender.com/updateBatch/${runningBatch._id}`, {
      method: 'POST',
      headers: { "Content-Type": "application/json" },
