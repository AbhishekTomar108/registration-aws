...
function FeedbackDemo() {
  ...
  useEffect(()=>{
    ...
    const SearchDemo = async()=>{
        ...
        let selectDemo = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getCounselorRangeDemoes`,{
          method:"GET",
          headers:{
  ...
  const setDemoFeedback = async(demoId,status)=>{
    ...
    let feedback = await fetch("https://dashboard-backend4-q7gq.onrender.com/addDemoStatus",{
        method:"PUT",
