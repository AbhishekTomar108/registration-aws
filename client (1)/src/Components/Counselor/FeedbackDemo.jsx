...
function FeedbackDemo() {
  ...
  useEffect(()=>{
    ...
    const SearchDemo = async()=>{
        ...
        let selectDemo = await fetch(`http://127.0.0.1:8000/getCounselorRangeDemoes`,{
          method:"GET",
          headers:{
  ...
  const setDemoFeedback = async(demoId,status)=>{
    ...
    let feedback = await fetch("http://127.0.0.1:8000/addDemoStatus",{
        method:"PUT",
...
function AllTrainerDemo() {
  ...
  const [rangeDate, setRangeDate]=  useState({
    ...
    const SearchDemo = async()=>{
        ...
        let selectDemo = await fetch("http://127.0.0.1:8000/getRangeDemoes",{
          method:"GET",
          headers:{
            "startDate":rangeDate.startDate,
            "endDate":rangeDate.endDate
