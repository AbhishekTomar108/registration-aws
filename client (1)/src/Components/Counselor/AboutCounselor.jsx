...
useEffect(()=>{
  ...
  const getCounselorStudent = async(id)=>{
    ...
    let CounselorStudent = await fetch('https://dashboard-backend4-q7gq.onrender.com/getStudentByCounselor', {
      method: 'POST',
  ...
  //   let studentData = await fetch('https://dashboard-backend4-q7gq.onrender.com/getStudentByCounselor', {
  //     method: 'POST',
  //     headers: { "Content-Type": "application/json" },
  ...
  const deleteuser = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(`https://dashboard-backend4-q7gq.onrender.com/deleteuser/${id}`, {
          method: "DELETE",
          headers: {
