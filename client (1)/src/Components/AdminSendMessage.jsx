...
const individualCheckFunc =(allUser)=>{
  ...
  console.log("send message function")
    ...
    ContextValue.updateBarStatus(true)
      ...
      try{
      let data = await fetch('https://dashboard-backend4-q7gq.onrender.com/sendmessage', {
      method: 'POST',
      headers: {
  ...
  const receivemessage = async (id) => {
    ...
    const messageRes = await fetch(`https://dashboard-backend4-q7gq.onrender.com/receiveusermessage/${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
