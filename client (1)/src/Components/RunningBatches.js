...
const RunningBatches = () => {
  ...
  const deleteuser = async (id) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(`https://dashboard-backend4-q7gq.onrender.com/deleteBatch/${id}`, {
          method: "DELETE",
          headers: {
  ...
  const getrunningBatch = async () => {
    ...
    let runningBatches = await fetch('https://dashboard-backend4-q7gq.onrender.com/getrunningBatch');
