...
const StudentState = (props) => {
  ...
  const checkAdmin = async () => {
    let userStatus = await fetch("https://dashboard-backend4-q7gq.onrender.com/fetchadmin", {
      method: "POST",
      headers: {
  ...
  const checkTrainer = async () => {
        ...
        let userStatus = await fetch("https://dashboard-backend4-q7gq.onrender.com/fetchtrainer", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
  ...
  const checkStudent = async () => {
    let userStatus = await fetch("https://dashboard-backend4-q7gq.onrender.com/fetchstudent", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
  ...
  const checkCounsellor = async () => {
    let userStatus = await fetch("https://dashboard-backend4-q7gq.onrender.com/fetchcounselor", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
  ...
  const checkCounsellorById = async (id) => {
    let userStatus = await fetch(`https://dashboard-backend4-q7gq.onrender.com/fetchcounselor/${id}`, {
      method: "GET",
    });
  ...
  const getAllMainSubCourse = async (id) => {
    let AllCourse = await fetch(`https://dashboard-backend4-q7gq.onrender.com/allSubMainCourse`, {
      method: "GET",
    });
  ...
  const getAllBatchCourse = async () => {
    ...
    try{
    let allbatchCourse = await fetch("https://dashboard-backend4-q7gq.onrender.com/getAllBatches", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
  ...
  const getAllMainCourse = async () => {
    let allMainCourse = await fetch("https://dashboard-backend4-q7gq.onrender.com/getAllMainCourse",{
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
  ...
  const getAllDemoListCounselor  = async(id)=>{
    let counselorDemo = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getCounselorDemo/`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "id":id,
  ...
  const getTrainerRunningBatch = async (id) => {
    let runningBatch = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getrunningBatchByTrainer`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "id":id
  ...
  const getRunningBatchStudent = async (batch) => {
    ...
    let runningBatch = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getRunningBatchStudent/`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "batch":batch,
  ...
  const getRunningBatch = async () => {
    let runningBatch = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getrunningBatch/`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
  ...
  const getBatchDetail = async(batch)=>{
    let batchData = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getBatchData/`, {
      method: "GET",
      headers: {"batch":batch}
    });
  ...
  const getAllCounselor = async () => {
    let allCounselor = await fetch("https://dashboard-backend4-q7gq.onrender.com/getAllCounselor", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
  ...
  const getAllTrainer = async () => {
    let allTrainer = await fetch("https://dashboard-backend4-q7gq.onrender.com/trainer", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
  ...
  const getAllCounselorStudent = async(id)=>{
    let counselorStudent = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getStudentByCounselor/${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
  ...
  const getSingleStudent = async (id) => {
    let Student = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getuser/${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
  ...
  const getReceiveMessage = async (id) => {
    ...
    const messageRes = await fetch(`https://dashboard-backend4-q7gq.onrender.com/receivemessage`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "id":id,
  ...
  const getStudentreceivemessage = async (id) => {
    ...
    const messageRes = await fetch(`https://dashboard-backend4-q7gq.onrender.com/Studentreceivemessage`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "id":id,
  ...
  const getSingleTrainer = async (id) => {
    let Trainer = await fetch(`https://dashboard-backend4-q7gq.onrender.com/trainer/${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
  ...
  const getAdminId = async()=>{
    let adminId = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getAdminId`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
  ...
  const getSingleCounselor = async (id) => {
    let Counselor = await fetch(`https://dashboard-backend4-q7gq.onrender.com/counselor/${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
  ...
  const getAllStudent = async () => {
    let allStudent = await fetch('https://dashboard-backend4-q7gq.onrender.com/studentpro')
  ...
  const getAttendance = async (date, id, batch) => {
    ...
    let attendanceData = await fetch('https://dashboard-backend4-q7gq.onrender.com/getStudentAttendance', {
      method: 'POST',
      headers: {
        "Content-Type": "application/json"
      },
  ...
  const getRegisterStudent = async()=>{
    ...
    try{
    let registerStudent = await fetch('https://dashboard-backend4-q7gq.onrender.com/getregisterStudent',{
      method:'GET'
    })
  ...
  const updatelastCollectionDate = async (nextDueDate, id, status) => {
    ...
    let updatelastDate = await fetch(`https://dashboard-backend4-q7gq.onrender.com/updatelastCollectionDate/${id}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
      },
  ...
  const getStudentMonthFeeStatus = async(month, year)=>{
    let getstudentFeesStatus = await fetch("https://dashboard-backend4-q7gq.onrender.com/getStudentMonthFeesStatus",{
      method:'GET',
  ...
  const updatePaymentStatus = async (status, id) => {
    ...
    let updatePayment = await fetch(`https://dashboard-backend4-q7gq.onrender.com/updatePaymentStatus/${id}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
      },
  ...
  const getBatchByTrainer = async (TrainerId) => {
    ...
    let trainerBatch = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getTrainerBatch/`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "id":TrainerId
  ...
  const getFiles = async (batch, trainerID) => {
    let getFilesData = await fetch('https://dashboard-backend4-q7gq.onrender.com/getfile', {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "batch": batch,
  ...
  const totalStudent =async()=>{
    let total = await fetch('https://dashboard-backend4-q7gq.onrender.com/getAllStudent',{
                method:'GET'
  })
  ...
  const newStudent = async(currentMonth)=>{
    let newTotal = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getNewStudent/${currentMonth}`,{
                method:'GET'
        })
  ...
  const totalNewTrainerStudent = async(trainerId)=>{
    ...
    let trainerStudent = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getNewTrainerStudent/`,{
      method:'GET',
...
return trainerStudent.newStudent
  ...
  const totalNewCounselorStudent = async(counselorId)=>{
    let month = (new Date().getMonth() + 1).toString().padStart(2, '0');
    let trainerStudent = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getNewCounselorStudent/`,{
      method:'GET',
...
return trainerStudent.newStudent
  ...
  const getTotalFees = async()=>{
    let totalFees = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getTotalFees`,{
      method:'GET',
})
  ...
  const getCounselorTotalFees = async(id)=>{
    let totalFees = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getCounselorTotalFees`,{
      method:'GET',
      headers:{"id":id}
})
  ...
  const getCounselorNewTotalFees = async(id)=>
  {
    ...
    month = month + 1
    let totalFees = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getCounselorNewTotalFees`,{
    method:'GET',
  ...
  const getOldStudent = async () => {
    let oldStudent = await fetch('https://dashboard-backend4-q7gq.onrender.com/getoldStudent')
...
const getTrainerDemo = async(id)=>{
    let trainerDemo = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getDemoesByTrainer/${id}`)

    trainerDemo = await trainerDemo.json()
    return trainerDemo
}
const getCounselorDemo = async(id)=>{
    let counselorDemo = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getDemoesByCounselor/${id}`)
...
const getTrainerNewDemo = async(id,month)=>{
  console.log('state new demo =',month)
    let trainerDemo = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getNewDemoesByTrainer/${id}`,{
      method:'GET',
      headers:{"month":month}
    })
...
const getCounselorNewDemo = async(id,month)=>{
  console.log('state new demo =',month,id)
    let counselorDemo = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getNewDemoesByCounselor`,{
      method:'GET',
      headers:{"month":month,"id":id}
    })
    counselorDemo = await counselorDemo.json()
...
const getAllDemo = async()=>{
    ...
    try{
  let AllDemo = await fetch(`https://dashboard-backend4-q7gq.onrender.com/Getdemo`,{
    method:'GET',
  })
...
const getDemo = async()=>{
  let AllDemo = await fetch(`https://dashboard-backend4-q7gq.onrender.com/GetAlldemo`,{
    method:'GET',
  })
...
const getNewDemo = async(month)=>{
  ...
  let newDemo = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getNewDemo/${month}`,{
    method:'GET',
  })
...
const getCounselorRegisterStudent = async(id)=>{
  ...
  let registerCounselorStudent = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getCounselorRegisterStudent`,{
    method:'GET',
    headers:{"id":id}
  })
...
const getCounselorNewRegisterStudent = async(id)=>{
  ...
  console.log('counselor register =',id)
  let registerCounselorStudent = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getCounselorNewRegisterStudent`,{
    method:'GET',
    headers:{"month":month,"id":id}
  })
...
const getPendingStudentAssignment = async(id,batch)=>{
  ...
  let pendingAssignment = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getStudentPendingAssignment/${id}`,{
    method:'GET',
    headers:{"batch":batch}
  })
...
const getSubmittedStudentAssignment = async(id,batch)=>{
  ...
  let submittedAssignment = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getStudentSubmittedAssignment/${id}`,{
    method:'GET',
    headers:{"batch":batch}
  })
...
const getTrainerAssignment = async(batch)=>{
  let trainerAssignment = await fetch("https://dashboard-backend4-q7gq.onrender.com/getTrainerAssignment",{
    method:'GET',
    headers:{"batch":batch}
  })
...
const getStudentNotesPdf = async(id,batch)=>{
  let TrainerNotesPdf = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getStudentNotesPdf/${id}`,{
    method:'GET',
    headers:{"batch":batch}
  })
...
const getStudentNotesLink = async(id,batch)=>{
  let TrainerNotesLink = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getStudentNotesLink/${id}`,{
    method:'GET',
    headers:{"batch":batch}
  })
...
const getTrainerNotesPdf = async(batch)=>{
  let TrainerNotesPdf = await fetch("https://dashboard-backend4-q7gq.onrender.com/getTrainerNotesPdf",{
    method:'GET',
    headers:{"batch":batch}
  })
...
const getTrainerNotesLink = async(batch)=>{
  let TrainerNotesLink = await fetch("https://dashboard-backend4-q7gq.onrender.com/getTrainerNotesLink",{
    method:'GET',
    headers:{"batch":batch}
  })
...
//   let res = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getUpcomingDemoesByCounselor`, {
//     method: "POST",
//     headers: {
//         "Content-Type": "application/json"
//     },
...
const counselorUpcomimgDemo = async (id) => {
  ...
  const res = await fetch("https://dashboard-backend4-q7gq.onrender.com/getUpcomingDemoesByCounselor", {
    method: "POST",
    headers: {
      "Content-Type": "application/json"
    },
...
const trainerUpcomimgDemo = async(id)=>{
  ...
  let res = await fetch("https://dashboard-backend4-q7gq.onrender.com/getTrainerUpcomingDemoes", {
    method: "POST",
    headers: {
        "Content-Type": "application/json"
    },
...
const UpcomimgDemo = async()=>{
  ...
  let res = await fetch("https://dashboard-backend4-q7gq.onrender.com/getupcomingDemoes", {
    method: "POST",
    headers: {
        "Content-Type": "application/json"
    },
...
const UpcomimgTrainerDemo = async(id)=>{
  ...
  let res = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getupcomingtrainerDemoes/${id}`, {
    method: "POST",
    headers: {
        "Content-Type": "application/json"
    },
