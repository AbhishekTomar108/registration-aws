...
const StudentState = (props) => {
  ...
  const checkAdmin = async () => {
    let userStatus = await fetch("http://127.0.0.1:8000/fetchadmin", {
      method: "POST",
      headers: {
  ...
  const checkTrainer = async () => {
        ...
        let userStatus = await fetch("http://127.0.0.1:8000/fetchtrainer", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
  ...
  const checkStudent = async () => {
    let userStatus = await fetch("http://127.0.0.1:8000/fetchstudent", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
  ...
  const checkCounsellor = async () => {
    let userStatus = await fetch("http://127.0.0.1:8000/fetchcounselor", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
  ...
  const checkCounsellorById = async (id) => {
    let userStatus = await fetch(`http://127.0.0.1:8000/fetchcounselor/${id}`, {
      method: "GET",
    });
  ...
  const getAllMainSubCourse = async (id) => {
    let AllCourse = await fetch(`http://127.0.0.1:8000/allSubMainCourse`, {
      method: "GET",
    });
  ...
  const getAllBatchCourse = async () => {
    ...
    try{
    let allbatchCourse = await fetch("http://127.0.0.1:8000/getAllBatches", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
  ...
  const getAllMainCourse = async () => {
    let allMainCourse = await fetch("http://127.0.0.1:8000/getAllMainCourse",{
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
  ...
  const getAllDemoListCounselor  = async(id)=>{
    let counselorDemo = await fetch(`http://127.0.0.1:8000/getCounselorDemo/`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "id":id,
  ...
  const getTrainerRunningBatch = async (id) => {
    let runningBatch = await fetch(`http://127.0.0.1:8000/getrunningBatchByTrainer`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "id":id
  ...
  const getRunningBatchStudent = async (batch) => {
    ...
    let runningBatch = await fetch(`http://127.0.0.1:8000/getRunningBatchStudent/`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "batch":batch,
  ...
  const getRunningBatch = async () => {
    let runningBatch = await fetch(`http://127.0.0.1:8000/getrunningBatch/`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
  ...
  const getBatchDetail = async(batch)=>{
    let batchData = await fetch(`http://127.0.0.1:8000/getBatchData/`, {
      method: "GET",
      headers: {"batch":batch}
    });
  ...
  const getAllCounselor = async () => {
    let allCounselor = await fetch("http://127.0.0.1:8000/getAllCounselor", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
  ...
  const getAllTrainer = async () => {
    let allTrainer = await fetch("http://127.0.0.1:8000/trainer", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
  ...
  const getAllCounselorStudent = async(id)=>{
    let counselorStudent = await fetch(`http://127.0.0.1:8000/getStudentByCounselor/${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
  ...
  const getSingleStudent = async (id) => {
    let Student = await fetch(`http://127.0.0.1:8000/getuser/${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
  ...
  const getReceiveMessage = async (id) => {
    ...
    const messageRes = await fetch(`http://127.0.0.1:8000/receivemessage`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "id":id,
  ...
  const getStudentreceivemessage = async (id) => {
    ...
    const messageRes = await fetch(`http://127.0.0.1:8000/Studentreceivemessage`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "id":id,
  ...
  const getSingleTrainer = async (id) => {
    let Trainer = await fetch(`http://127.0.0.1:8000/trainer/${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
  ...
  const getAdminId = async()=>{
    let adminId = await fetch(`http://127.0.0.1:8000/getAdminId`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
  ...
  const getSingleCounselor = async (id) => {
    let Counselor = await fetch(`http://127.0.0.1:8000/counselor/${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      }
  ...
  const getAllStudent = async () => {
    let allStudent = await fetch('http://127.0.0.1:8000/studentpro')
  ...
  const getAttendance = async (date, id, batch) => {
    ...
    let attendanceData = await fetch('http://127.0.0.1:8000/getStudentAttendance', {
      method: 'POST',
      headers: {
        "Content-Type": "application/json"
      },
  ...
  const getRegisterStudent = async()=>{
    ...
    try{
    let registerStudent = await fetch('http://127.0.0.1:8000/getregisterStudent',{
      method:'GET'
    })
  ...
  const updatelastCollectionDate = async (nextDueDate, id, status) => {
    ...
    let updatelastDate = await fetch(`http://127.0.0.1:8000/updatelastCollectionDate/${id}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
      },
  ...
  const getStudentMonthFeeStatus = async(month, year)=>{
    let getstudentFeesStatus = await fetch("http://127.0.0.1:8000/getStudentMonthFeesStatus",{
      method:'GET',
  ...
  const updatePaymentStatus = async (status, id) => {
    ...
    let updatePayment = await fetch(`http://127.0.0.1:8000/updatePaymentStatus/${id}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
      },
  ...
  const getBatchByTrainer = async (TrainerId) => {
    ...
    let trainerBatch = await fetch(`http://127.0.0.1:8000/getTrainerBatch/`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "id":TrainerId
  ...
  const getFiles = async (batch, trainerID) => {
    let getFilesData = await fetch('http://127.0.0.1:8000/getfile', {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "batch": batch,
  ...
  const totalStudent =async()=>{
    let total = await fetch('http://127.0.0.1:8000/getAllStudent',{
                method:'GET'
  })
  ...
  const newStudent = async(currentMonth)=>{
    let newTotal = await fetch(`http://127.0.0.1:8000/getNewStudent/${currentMonth}`,{
                method:'GET'
        })
  ...
  const totalNewTrainerStudent = async(trainerId)=>{
    ...
    let trainerStudent = await fetch(`http://127.0.0.1:8000/getNewTrainerStudent/`,{
      method:'GET',
...
return trainerStudent.newStudent
  ...
  const totalNewCounselorStudent = async(counselorId)=>{
    let month = (new Date().getMonth() + 1).toString().padStart(2, '0');
    let trainerStudent = await fetch(`http://127.0.0.1:8000/getNewCounselorStudent/`,{
      method:'GET',
...
return trainerStudent.newStudent
  ...
  const getTotalFees = async()=>{
    let totalFees = await fetch(`http://127.0.0.1:8000/getTotalFees`,{
      method:'GET',
})
  ...
  const getCounselorTotalFees = async(id)=>{
    let totalFees = await fetch(`http://127.0.0.1:8000/getCounselorTotalFees`,{
      method:'GET',
      headers:{"id":id}
})
  ...
  const getCounselorNewTotalFees = async(id)=>
  {
    ...
    month = month + 1
    let totalFees = await fetch(`http://127.0.0.1:8000/getCounselorNewTotalFees`,{
    method:'GET',
  ...
  const getOldStudent = async () => {
    let oldStudent = await fetch('http://127.0.0.1:8000/getoldStudent')
...
const getTrainerDemo = async(id)=>{
    let trainerDemo = await fetch(`http://127.0.0.1:8000/getDemoesByTrainer/${id}`)

    trainerDemo = await trainerDemo.json()
    return trainerDemo
}
const getCounselorDemo = async(id)=>{
    let counselorDemo = await fetch(`http://127.0.0.1:8000/getDemoesByCounselor/${id}`)
...
const getTrainerNewDemo = async(id,month)=>{
  console.log('state new demo =',month)
    let trainerDemo = await fetch(`http://127.0.0.1:8000/getNewDemoesByTrainer/${id}`,{
      method:'GET',
      headers:{"month":month}
    })
...
const getCounselorNewDemo = async(id,month)=>{
  console.log('state new demo =',month,id)
    let counselorDemo = await fetch(`http://127.0.0.1:8000/getNewDemoesByCounselor`,{
      method:'GET',
      headers:{"month":month,"id":id}
    })
    counselorDemo = await counselorDemo.json()
...
const getAllDemo = async()=>{
    ...
    try{
  let AllDemo = await fetch(`http://127.0.0.1:8000/Getdemo`,{
    method:'GET',
  })
...
const getDemo = async()=>{
  let AllDemo = await fetch(`http://127.0.0.1:8000/GetAlldemo`,{
    method:'GET',
  })
...
const getNewDemo = async(month)=>{
  ...
  let newDemo = await fetch(`http://127.0.0.1:8000/getNewDemo/${month}`,{
    method:'GET',
  })
...
const getCounselorRegisterStudent = async(id)=>{
  ...
  let registerCounselorStudent = await fetch(`http://127.0.0.1:8000/getCounselorRegisterStudent`,{
    method:'GET',
    headers:{"id":id}
  })
...
const getCounselorNewRegisterStudent = async(id)=>{
  ...
  console.log('counselor register =',id)
  let registerCounselorStudent = await fetch(`http://127.0.0.1:8000/getCounselorNewRegisterStudent`,{
    method:'GET',
    headers:{"month":month,"id":id}
  })
...
const getPendingStudentAssignment = async(id,batch)=>{
  ...
  let pendingAssignment = await fetch(`http://127.0.0.1:8000/getStudentPendingAssignment/${id}`,{
    method:'GET',
    headers:{"batch":batch}
  })
...
const getSubmittedStudentAssignment = async(id,batch)=>{
  ...
  let submittedAssignment = await fetch(`http://127.0.0.1:8000/getStudentSubmittedAssignment/${id}`,{
    method:'GET',
    headers:{"batch":batch}
  })
...
const getTrainerAssignment = async(batch)=>{
  let trainerAssignment = await fetch("http://127.0.0.1:8000/getTrainerAssignment",{
    method:'GET',
    headers:{"batch":batch}
  })
...
const getStudentNotesPdf = async(id,batch)=>{
  let TrainerNotesPdf = await fetch(`http://127.0.0.1:8000/getStudentNotesPdf/${id}`,{
    method:'GET',
    headers:{"batch":batch}
  })
...
const getStudentNotesLink = async(id,batch)=>{
  let TrainerNotesLink = await fetch(`http://127.0.0.1:8000/getStudentNotesLink/${id}`,{
    method:'GET',
    headers:{"batch":batch}
  })
...
const getTrainerNotesPdf = async(batch)=>{
  let TrainerNotesPdf = await fetch("http://127.0.0.1:8000/getTrainerNotesPdf",{
    method:'GET',
    headers:{"batch":batch}
  })
...
const getTrainerNotesLink = async(batch)=>{
  let TrainerNotesLink = await fetch("http://127.0.0.1:8000/getTrainerNotesLink",{
    method:'GET',
    headers:{"batch":batch}
  })
...
//   let res = await fetch(`http://127.0.0.1:8000/getUpcomingDemoesByCounselor`, {
//     method: "POST",
//     headers: {
//         "Content-Type": "application/json"
//     },
...
const counselorUpcomimgDemo = async (id) => {
  ...
  const res = await fetch("http://127.0.0.1:8000/getUpcomingDemoesByCounselor", {
    method: "POST",
    headers: {
      "Content-Type": "application/json"
    },
...
const trainerUpcomimgDemo = async(id)=>{
  ...
  let res = await fetch("http://127.0.0.1:8000/getTrainerUpcomingDemoes", {
    method: "POST",
    headers: {
        "Content-Type": "application/json"
    },
...
const UpcomimgDemo = async()=>{
  ...
  let res = await fetch("http://127.0.0.1:8000/getupcomingDemoes", {
    method: "POST",
    headers: {
        "Content-Type": "application/json"
    },
...
const UpcomimgTrainerDemo = async(id)=>{
  ...
  let res = await fetch(`http://127.0.0.1:8000/getupcomingtrainerDemoes/${id}`, {
    method: "POST",
    headers: {
        "Content-Type": "application/json"
    },
