...
export default function Student() {
  ...
  const receivemessage = async () => {
    ...
    const messageRes = await fetch(`https://dashboard-backend4-q7gq.onrender.com/receivemessage/${id}`, {
      method: "GET",
      headers: {
    ...
    const res = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getuser/${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
