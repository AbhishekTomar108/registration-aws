...
const Assignment = (props) => {
  ...
  let contextValue = useContext(StudentContext);
    ...
    const sendAssignment = async (e,id,url,file) => {
        ...
        try {
            const res = await fetch('https://dashboard-backend4-q7gq.onrender.com/submititem', {
                method: 'POST',
                body: formData,
            });
    ...
    const getTrainerdata = async () => {
        const res = await fetch("https://dashboard-backend4-q7gq.onrender.com/getuploadAssignmentUrl", {
    ...
    const downloaduser = async (url) => {
        ...
        const res2 = await fetch(`https://dashboard-backend4-q7gq.onrender.com/files/${url}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json"
            }
