...
let selectRegister
  try{
  selectDemo = await fetch("https://dashboard-backend4-q7gq.onrender.com/getRangeDemoes",{
    method:"GET",
    headers:{
 ...
 try{
  selectRegister = await fetch("https://dashboard-backend4-q7gq.onrender.com/getRangeRegisteredStudent",{
    method:"GET",
    headers:{
      "startDate":rangeDate.startDate,
      "endDate":rangeDate.endDate
