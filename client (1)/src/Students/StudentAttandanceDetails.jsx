...
function StudentAttandanceDetails() {
  ...
  const getAttendance = async(student) => {
    ...
    let filterStatus = await fetch("https://dashboard-backend4-q7gq.onrender.com/getMonthAttendance", {
      method: "POST",
  ...
  const getstudent = async () => {
    let res = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getuser/${id}`, {
      method: "GET",
      headers: {
