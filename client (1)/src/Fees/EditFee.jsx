...
function EditFee() {
  ...
  const getdata = async () => {
    const res = await fetch(`https://dashboard-backend4-q7gq.onrender.com/getfee/${id}`, {
      method: "GET",
      headers: {
  ...
  const updateUser = async (e) => {
    ...
    const res2 = await fetch(`https://dashboard-backend4-q7gq.onrender.com/FeeDetail/${id}`, {
