...
function FeeTable() {
  ...
  const getTrainerdata = async () => {
    const res = await fetch("https://dashboard-backend4-q7gq.onrender.com/FeeTable", {
      method: "GET",
      headers: {
  ...
  const deleteuser = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(`https://dashboard-backend4-q7gq.onrender.com/deleteFee/${id}`, {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json"
          }
  ...
  const getAllStudentPaymentStatus =async()=>{
    ...
    let studentPaymentStatus = await fetch("https://dashboard-backend4-q7gq.onrender.com/getStudentFeesStatus")
  ...
  const SearchStudentFees = async()=>{
    ...
    let getRangeFees = await fetch("https://dashboard-backend4-q7gq.onrender.com/getRangeFees",{
      method:"GET",
      headers:{
